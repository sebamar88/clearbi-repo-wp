...
if ( ! class_exists( 'WP_Bootstrap_Navwalker_movil' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class WP_Bootstrap_Navwalker_movil extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( empty( $item->attr_title ) ) {
				$atts['aria-label'] = ! empty( $item->title ) ? strip_tags( $item->title ) : '';
			} else {
